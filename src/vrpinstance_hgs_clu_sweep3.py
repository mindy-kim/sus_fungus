"""Improved CVRP solver - drop-in replacement targeted at medium-large
tight-capacity instances (e.g. 386 customers / 47 vehicles / 97% utilisation).
...
Public API unchanged: VRPInstance(filename) -> .solve(time_budget_s, seed).
"""
